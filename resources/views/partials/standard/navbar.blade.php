    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item ">
            <div class="user-panel d-flex">
                <div class="image">
                    <img src="{{ asset('https://visualpharm.com/assets/545/Online%20Support-595b40b65ba036ed117d0af0.svg') }}" class="img-circle elevation-2" alt="User Image">
                </div>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-left">
                <a href="{{ url('/standard_users/dashboard') }}" class="dropdown-item">
                    <i class="nav-icon fas fa-tachometer-alt"></i>CONTROL BOARD
                </a>
                ...
                <a href="{{ route('standard.announcements') }}" class="dropdown-item">
                    <i class="nav-icon fas fa-bullhorn"></i> DISCOUNTS
                </a>
                <div class="dropdown-divider"></div>
